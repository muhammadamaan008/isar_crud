...
extension PersonQueryFilter on QueryBuilder<Person, Person, QFilterCondition> {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> imageUrlEqualTo(
    String value, {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> imageUrlGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> imageUrlLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> imageUrlBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> imageUrlStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> imageUrlEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> imageUrlContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> imageUrlMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> imageUrlIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'imageUrl',
        value: '',
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> imageUrlIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'imageUrl',
        value: '',
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> timeStampEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> timeStampGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> timeStampLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> timeStampBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PersonQuerySortBy on QueryBuilder<Person, Person, QSortBy> {
  ...
  QueryBuilder<Person, Person, QAfterSortBy> sortByImageUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imageUrl', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> sortByImageUrlDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterSortBy> sortByTimeStamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeStamp', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> sortByTimeStampDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PersonQuerySortThenBy on QueryBuilder<Person, Person, QSortThenBy> {
  ...
  QueryBuilder<Person, Person, QAfterSortBy> thenByImageUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imageUrl', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> thenByImageUrlDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imageUrl', Sort.desc);
    });
  }
  ...
  QueryBuilder<Person, Person, QAfterSortBy> thenByTimeStamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeStamp', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> thenByTimeStampDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeStamp', Sort.desc);
    });
  }
...
extension PersonQueryWhereDistinct on QueryBuilder<Person, Person, QDistinct> {
  ...
  QueryBuilder<Person, Person, QDistinct> distinctByImageUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QDistinct> distinctByTimeStamp() {
    return QueryBuilder.apply(this, (query) {
...
extension PersonQueryProperty on QueryBuilder<Person, Person, QQueryProperty> {
  ...
  QueryBuilder<Person, String, QQueryOperations> imageUrlProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, int, QQueryOperations> timeStampProperty() {
    return QueryBuilder.apply(this, (query) {
